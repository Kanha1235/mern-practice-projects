let videos = [ "4879375_Gyps Fulvus_Griffon Vulture_3840x2160" , "456540_Thailand_Bangkok_1920x1080" , "6356499_Herd_Afghanistan_3840x2160" ,"big_buck_bunny_720p_10mb"]
        ...
        videos.forEach((name,i)=>{
            videoList.insertAdjacentHTML(
                ...
                <video data-key="${i}" width="157px" >
                    <source src="./assets/${videos[i]}.mp4">
                </video>
        ...
        playBox.innerHTML = `<video controls autoplay muted loop width="100%" >
                <source src="./assets/4879375_Gyps Fulvus_Griffon Vulture_3840x2160.mp4">
            </video>
